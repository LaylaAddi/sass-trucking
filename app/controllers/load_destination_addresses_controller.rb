class LoadDestinationAddressesController < AddressesController
  ...
  def new
    ...
    @address = @load.load_destination_addresses.new
  end
  ...
  def create
    @load = Load.find(params[:load_id])
    @address = @load.load_destination_addresses.new(address_params) 
  ...
  private
    ...
    def address_params
      params.require(:load_destination_address).permit( 
        :address_type, 
        :street, 
        :latitude, 
        :longitude, 
