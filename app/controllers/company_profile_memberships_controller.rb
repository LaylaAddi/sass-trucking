class CompanyProfileMembershipsController < ApplicationController
  ...
  def index
    @company_profile_memberships = CompanyProfileMembership.all
  end
  ...
  def new
    ...
    @company_profile_membership = CompanyProfileMembership.new
  end
  ...
  def create
    ...
    respond_to do |format|
      if @company_profile_membership.save
        format.html { redirect_to @company_profile_membership, notice: 'Company profile membership was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @company_profile_membership.update(company_profile_membership_params)
        format.html { redirect_to @company_profile_membership, notice: 'Company profile membership was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to company_profile_memberships_url, notice: 'Company profile membership was successfully destroyed.' }
