...
class StatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post statements_url, params: { statement: { driver_user_id: @statement.driver_user_id, escrow: @statement.escrow, insurance_payment: @statement.insurance_payment, trailer_rental: @statement.trailer_rental, truck_rental: @statement.truck_rental } }
    end
  ...
  test "should update statement" do
    patch statement_url(@statement), params: { statement: { driver_user_id: @statement.driver_user_id, escrow: @statement.escrow, insurance_payment: @statement.insurance_payment, trailer_rental: @statement.trailer_rental, truck_rental: @statement.truck_rental } }
